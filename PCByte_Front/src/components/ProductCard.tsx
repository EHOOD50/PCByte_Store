...
const ProductCard: React.FC<ProductCardProps> = ({ product, addToCart }) => {
  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-[1.75rem] border border-white/10 bg-white text-slate-900 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#97cf00]/70 hover:shadow-[0_24px_55px_rgba(151,207,0,0.18)]">
      <div className="relative m-3 mb-0 flex h-52 items-center justify-center overflow-hidden rounded-[1.35rem] bg-slate-50 p-5">
        <img
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <div className="mt-auto pt-4">
          ...
          <button
            ...
            className={`flex h-11 w-full items-center justify-center gap-2 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all duration-300 ${
              isOutOfStock
